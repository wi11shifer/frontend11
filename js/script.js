$(document).ready(function() {
    const words = [
      ...
      { word: 'Family', translation: ["Родина", "Сім'я"] },
      { word: 'Love', translation: ["Кохання", "Любов"] },
      ...
      { word: 'Learning', translation: 'Вивчення' },
...
function checkAnswer(index, userTranslation) {
  ...
  if (Array.isArray(correctTranslations)) {
      return correctTranslations.some(t => t.toLowerCase() === userTranslation.toLowerCase());
  } else {
